...
module.exports = { normal, peach, goma, oceanBreeze, frightFest, booBash, celestialGrace, sakuraSerenity, buzzingBliss, spiderMan, cucumberCool, cappuccinoCharm, froggyFun }