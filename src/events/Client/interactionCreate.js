    ...
    if (
      ...
      if (!interaction.isButton()) {
        if (action === 'buy') {
          ...
          // Add your logic here for purchasing the item
          // For example, check user balance, deduct price, update user profile, etc.

          await interaction.reply({ content: `You have successfully purchased **${item.name}**!`, ephemeral: true });
        }
      } else {
        return;
      }
