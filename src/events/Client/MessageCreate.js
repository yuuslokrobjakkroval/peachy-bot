                                    ...
                                    if (int.customId === 'register') {
                                        try {
                                            const embed = this.client
                                                .embed()
                                                .setColor(color.main)
                                                .setTitle(`${emoji.mainLeft} WELCOME ${emoji.mainRight}`)
                                                .setThumbnail(
                                        ...
                                        try {
                                            const embed = this.client
                                                .embed()
                                                .setColor(color.main)
                                                .setTitle(`${emoji.mainLeft} PRIVACY POLICY ${emoji.mainRight}`)
                                                .setDescription(
                                                    `**Introduction**\n` +
                                        ...
                                        const embed = this.client
                                            ...
                                            .setDescription(
                                                ...
                                                }!!\nYou got ${this.client.utils.formatNumber(gift)} ${
                                                    emoji.coin
                                        ...
                                        await int.editReply({
                                            embeds: [
                                                this.client
                                                    ...
                                                    .setTitle(`${emoji.mainLeft} THANK YOU ${ctx.author.displayName} ${emoji.mainRight}`)
                                                    .setDescription(
                                    ...
                                    const timeoutEmbed = this.client
                                        ...
                                        .setDescription(
                                            generalMessages.title
                                                ...
                                                .replace('%{mainRight}', emoji.mainRight) + "⏳ Time is up! You didn't register."
                                        )
                                        .setFooter({
