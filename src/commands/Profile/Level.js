  ...
  async drawLevel(
    ...
    const userInfoDetail = [
      ...
      },
      {
        label: "Level",
        description:
          userInfo.profile && userInfo.profile.level
      ...
      },
      {
        label: "Exp",
        description:
          userInfo.profile && userInfo.profile.xp
            ? `${userInfo.profile.xp} / ${userInfo.profile.levelXp}`
            : null,
        x: 895,
        y: 300,
      },
      {
        ...
        description: this.getConsumedItems(client, userInfo),
        x: 895,
        y: 380,
      },
    ];
