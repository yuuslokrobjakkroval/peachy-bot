...
module.exports = class Drink extends Command {
  ...
  async run(client, ctx, args, color, emoji, language) {
    ...
    const drinkMessages = language.locales.get(language.defaultLocale)
      ?.inventoryMessages?.drinkMessages;
    ...
    try {
      ...
      if (!itemInfo) {
        return await client.utils.sendErrorMessage(
          client,
          ctx,
          drinkMessages.itemNotFound.replace("%{itemId}", itemId),
          color,
        );
      }
