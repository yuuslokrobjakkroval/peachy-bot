...
The coin is flips ${win ? (choice === 'p' ? client.emoji.coinFlip.peach : client.emoji.coinFlip.goma) : (choice === 'p' ? client.emoji.coinFlip.peach : client.emoji.coinFlip.goma)} and ${
                    win
