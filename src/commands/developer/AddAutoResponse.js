...
module.exports = class AddAutoResponse extends Command {
  constructor(client) {
    super(client, {
      ...
      description: {
        content:
          "Add an autoresponse trigger and response for a specific guild.",
      ...
      return ctx.sendMessage({
        embeds: [
          client
            ...
            .setDescription(
              client.i18n.get(language, "commands", "invalid_args")
            ),
        ],
      });
    }
            ...
            ctx.sendMessage({
              embeds: [
                client
                  ...
                  .setColor(color.danger)
                  .setDescription(
                    "Failed to save the autoresponse. Please try again."
                  ),
              ],
            });
          });
        ...
        ctx.sendMessage({
          embeds: [
            client
              ...
              .setColor(color.danger)
              .setDescription(
                "An error occurred while fetching autoresponses. Please try again."
              ),
          ],
        });
      });
