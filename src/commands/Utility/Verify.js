...
module.exports = class Verify extends Command {
  ...
  async run(client, ctx, args, color, emoji, language) {
    ...
    await ctx.sendMessage({ embeds: [confirmEmbed], components: [row], flags: 64 });
    ...
    collector.on("collect", async (i) => {
      ...
      if (i.customId === "confirm") {
        ...
        await i.update({embeds: [verificationEmbed], components: userPaymentStatus === "paid" ? [verificationRow] : [], flags: 64 });
      } else if (i.customId === "cancel") {
        await i.update({content: verifyMessages?.thankYou || "Thank you!", embeds: [], components: [], flags: 64 });
      }
