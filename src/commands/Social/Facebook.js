...
module.exports = class Facebook extends Command {
  constructor(client) {
    super(client, {
      name: "facebook",
      description: {
        content: `Manage your Facebook profile.`,
        examples: [
    ...
    switch (subCommand) {
      case "name": {
        ...
        embed
          ...
          .addFields([
            {
              name: fbMessages?.newName || "New Facebook Name",
              value: `\`\`\`${name}\n\`\`\``,
              inline: false,
            },
          ]);
      ...
      case "link": {
        ...
        embed
          ...
          .addFields([
            {
              name: fbMessages?.newLink || "New Facebook Link",
              value: `\`\`\`${link}\n\`\`\``,
              inline: false,
            },
          ])
      ...
      case "help": {
        embed
          ...
          .addFields([
            {
              name: fbMessages?.showDetails || "Show Facebook Details",
              value: "````facebook` or `facebook @mention```",
              inline: false,
            },
            {
              name: fbMessages?.setName || "Set Facebook Name",
              value: "````facebook name YourFacebookName```",
              inline: false,
            },
            {
              name: fbMessages?.setLink || "Set Facebook Link",
              value:
                "````facebook link https://facebook.com/YourFacebookLink````",
              inline: false,
            },
            {
              name: fbMessages?.commandHelp || "Command Help",
              value: "````facebook help```",
              inline: false,
            },
          ]);
      ...
      default: {
        const fbName =
          user.social.facebook.name || fbMessages?.notSet || "Not set";
