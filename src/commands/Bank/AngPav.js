...
module.exports = class Transfer extends Command {
  constructor(client) {
    super(client, {
      name: "angpav",
      description: {
        content: "𝑨𝒏𝒈𝒑𝒂𝒗 𝒄𝒐𝒊𝒏𝒆𝒔 𝒕𝒐 𝒂𝒏𝒐𝒕𝒉𝒆𝒓 𝒖𝒔𝒆𝒓.",
    ...
    collector.on("collect", async (interaction) => {
      ...
      if (interaction.customId === "confirm") {
        const confirmationEmbed = client.embed()
            ...
            .setDescription(
                generalMessages.title
                    ...
                    .replace("%{title}", "𝐀𝐍𝐆𝐏𝐀𝐕")
                    .replace("%{mainRight}", emoji.mainRight) +
                `𝑨𝒏𝒈𝒑𝒂𝒗 ${globalEmoji.angpav} 𝒘𝒂𝒔 𝒔𝒆𝒏𝒕 𝒔𝒖𝒄𝒄𝒆𝒔𝒇𝒖𝒍𝒍𝒚 .`
            )
            .setFooter({
        ...
        setTimeout(async () => {
          ...
          const buttons = [
            client.utils.fullOptionButton("btn_1", globalEmoji.angpav, "𝑪𝒉𝒐𝒊𝒄𝒆 𝟏", 2),
            client.utils.fullOptionButton("btn_2", globalEmoji.angpav, "𝑪𝒉𝒐𝒊𝒄𝒆 𝟐", 2),
            client.utils.fullOptionButton("btn_3", globalEmoji.angpav, "𝑪𝒉𝒐𝒊𝒄𝒆 𝟑", 2),
            client.utils.fullOptionButton("btn_4", globalEmoji.angpav, "𝑪𝒉𝒐𝒊𝒄𝒆 𝟒", 2),
          ];
          ...
          collector.on("collect", async (interaction) => {
            ...
            } else if (interaction.customId === "btn_2") {
              angpavAmount = amount / 2;
              target.balance.coin += Math.floor(amount / 2);
            } else if (interaction.customId === "btn_3") {
              angpavAmount = amount / 3;
              target.balance.coin += Math.floor(amount / 3);
            } else if (interaction.customId === "btn_4") {
              angpavAmount = 0;
              await ctx.sendMessage({
                embeds: [client.embed().setColor(color.warning).setDescription("𝑻𝒓𝒚 𝒂𝒈𝒂𝒊𝒏 𝒏𝒆𝒙𝒕 𝒚𝒆𝒂𝒓!")],
                components: [],
              });
              angMsg.delete();
              return;
            ...
            const successEmbed = client.embed()
                ...
                .setDescription(
                    ...
                    angPavMessages.success
                        ...
                        .replace("%{amount}", client.utils.formatNumber(parseInt(angpavAmount)))
                        .replace("%{emoji}", emoji.coin)
                )
                .setFooter({
